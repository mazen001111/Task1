...
Console.WriteLine($"the total price of small carpet rooms cleaning is : {numberOfSmallCarpets * 250} $\n");
Console.WriteLine($"the total price of Large carpet rooms cleaning is : {numberOfLargeCarpets * 350} $\n");
